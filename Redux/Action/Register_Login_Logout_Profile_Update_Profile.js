...
export const Register = (data) => async (dispatch) => {
  axios
    .post(
      "https://technical-knowledge-backend-node-rest.vercel.app/Register",
      data
    )
    .then((res) => {
...
export const Login = (data) => async (dispatch) => {
  axios
    .post(
      "https://technical-knowledge-backend-node-rest.vercel.app/Login",
      data
    )
    .then((res) => {
...
export const Update_Profile_Detailes = (data) => async (dispatch) => {
  if (window.confirm("Do You Really Want To Update This User")) {
    axios
      .post(
        "https://technical-knowledge-backend-node-rest.vercel.app/Blogsusers/Update",
        data
      )
      .then((res) => {
        dispatch({
