...
export default function Blog_Posts_share_comment_Question(props) {
  ...
  if (email || name || message !== '') {
    ...
    return (
        <>
            <hr class="dropdown-dividers bg-dark" />
            <div class="px-1 py-2">
            ...
            <div class="px-0 py-2">
                ...
                <form>
                    <div class="mb-3">
                        <textarea class="form-control" rows="9" placeholder="Your Question:*" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Email:*"  value={email} onChange={(e) => setEmail(e.target.value)}/>
                    </div>
                    <div class="d-grid gap-2">
                        <button class="btn btn-primary" type="button" onClick={() => Submit(data._id)}>Post Your Question</button>
                    </div>
                </form>
            </div>
        </>
